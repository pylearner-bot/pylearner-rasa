...
parser.add_argument(
    '--bot-name', '-bn', type=str, default='Pyter',
...
parser.add_argument(
    '--bot-avatar', '-ba', type=str, default='https://raw.githubusercontent.com/fga-eps-mds/2019.1-PyLearner/master/docs/img/Logo_text.jpg',
